<template>
	<div class="div_details_page">
		...
		<div class="div_src">
			<img class="bg_image" v-lazy=getImageUrl(story.image)>
			<h4 class="bg_title">{{story.title}}</h4>
		</div>
		<div class="body" v-html=attachBodyContent(story.body)></div>
	...
	export default{
		...
		methods:{
		    ...
		    openlinkonNewpage:function(){
		    	window.open(this.story.share_url);
		    },
